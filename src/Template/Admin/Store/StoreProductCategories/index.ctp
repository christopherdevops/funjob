<?php
    ...
    $this->Breadcrumbs->add(__('Categorie'));
?>
...
<div class="page-header" style="overflow:auto;">
    <h2 class="pull-left no-margin"><?= __('Categoria negozio') ?></h2>
        ...
        <p>
            <?php
                echo __('Puoi ricercare una determinata categoria tramite i tasti {shortcut}', [
                    'shortcut' => '<kbd><kbd>CTRL</kbd> + <kbd>F</kbd></kbd>'
                ])
            ?>
        </p>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="clt well">
            ...
            <?php echo $this->Tree->treeListAdmin($StoreProductCategories) ?>
        </div>
    </div>
</div>
